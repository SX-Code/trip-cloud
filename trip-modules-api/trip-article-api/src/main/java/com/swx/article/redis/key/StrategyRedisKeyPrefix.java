...
public class StrategyRedisKeyPrefix extends BaseKeyPrefix {
    ...
    public static final StrategyRedisKeyPrefix STRATEGIES_STAT_COUNT_RANK_ZSET = new StrategyRedisKeyPrefix("STRATEGIES:STAT:COUNT:RANK");
    public static final StrategyRedisKeyPrefix STRATEGIES_TOP_MAP = new StrategyRedisKeyPrefix("STRATEGIES:TOP");
